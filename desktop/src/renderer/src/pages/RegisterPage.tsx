/* ── RegisterPage.tsx ────────────────────────────────────────────────────────
   Pixel-perfect implementation matching the PawCare Sign-up HTML design reference.
─────────────────────────────────────────────────────────────────────────── */
      ...
      <div className="flex flex-1 relative overflow-hidden">
        ...
        <div className="w-[44%] bg-[#1F3A2E] text-[#CFE0D3] relative px-16 pt-8 pb-12 flex flex-col justify-between overflow-hidden">
          ...
          <svg className="absolute inset-0 w-full h-full opacity-[0.05] pointer-events-none" viewBox="0 0 400 800" preserveAspectRatio="none">
            <defs>
              <pattern id="paws-reg" width="80" height="80" patternUnits="userSpaceOnUse">
            ...
            <rect width="100%" height="100%" fill="url(#paws-reg)"/>
          </svg>
          ...
          <div className="relative z-10 mt-12">
            ...
            <h1 className="font-serif text-[42px] leading-[1.18] font-normal text-[#F7F3E9] max-w-[9.5em]" style={{ fontFamily: 'Fraunces, serif' }}>
              Your cats deserve<br />
              <em className="italic text-[#E8813A] font-normal">smarter care.</em>
            </h1>
            <p className="mt-5 text-[15px] leading-relaxed text-[#CFE0D3]/85 max-w-[26em]">
              Set up in under a minute. Add your cats, enroll their faces, and start monitoring — all on your own hardware.
            </p>
          </div>
          ...
          <div className="w-[380px]">
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-4 text-left">
                <label htmlFor="fullName" className="block text-[13px] font-semibold text-[#22201B] mb-1.5">
                  Full name
                </label>
                <input
                  id="fullName"
                  type="text"
                  placeholder="Senan Ali"
                  value={fullName}
            ...
            <p className="text-center text-[13.5px] text-[#6B6558]">
              ...
              <Link to="/login" className="text-[#1F3A2E] font-semibold hover:underline">
                Sign in
              </Link>
            </p>
          </div>
